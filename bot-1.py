...
`!pescar` — Pesca (com itens e mensagens aleatórias!)
`!caçar` — Caça (com presas engraçadas!)
`!minerar` — Minera (com minérios variados!)
...
🏦 **Banco & Investimentos**
`!investir [valor]` — Investe fichas por 2-8h (lucro ou prejuízo)
...
🌍 **Servidor**
`!clima` — Ver o clima do dia e seus efeitos
`!humor` — Ver o humor do bot hoje
`!jornal` — Ver os últimos acontecimentos do servidor
`!memorias` — Ver os momentos épicos registrados

🚨 **Procurado**
`!procurado` — Ver quem está procurado
`!capturar @pessoa` — Capturar um procurado e ganhar a recompensa

🎯 **Progresso**
`!missoes` — Ver suas missões diárias
`!conquistas [@pessoa]` — Ver conquistas desbloqueadas
`!topsemana` — Ranking semanal de fichas ganhas
...
🧢 Pobre → 10k | 💵 Rico → 50k | 💎 Milionário → 100k | 🏦 Bilionário → 500k
