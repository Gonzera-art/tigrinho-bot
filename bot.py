...
`!apostar [valor]` — Aposta suas <:fichas:1517923672575185048> (mín. 50)
...
🎰 **Cassino** (mín. 50 <:fichas:1517923672575185048> em todos)
`!casino` — Ver todos os jogos disponíveis
`!blackjack [valor]` — Tente chegar a 21!
`!roleta [valor] [aposta]` — vermelho/preto/par/impar/número
`!slots [valor]` — Caça-níquel com jackpots
`!dados [valor] [2-12]` — Adivinhe a soma dos dados
`!hilo [valor] [maior/menor]` — Próxima carta maior ou menor?
`!guerra [valor]` — Sua carta vs dealer
`!crash [valor]` — Suba o multiplicador antes do crash!

`!bilhete [qtd]` — Comprar bilhetes (100 <:fichas:1517923672575185048> cada)
